...
export const REPAIR_STATUSES = {
  ...
  invoiced:      { label: 'Invoiced',          color: 'bg-cyan-100 text-cyan-800 border-cyan-400 dark:bg-cyan-900/40 dark:text-cyan-300 dark:border-cyan-600',                   dot: 'bg-cyan-500 dark:bg-cyan-400',             step: 8 },
