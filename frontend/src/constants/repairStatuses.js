...
export const REPAIR_STATUSES = {
  ...
  beyond_economical_repair: { label: 'Beyond Economical Repair', color: 'bg-red-100 text-red-700 border-red-400 dark:bg-red-900/30 dark:text-red-400 dark:border-red-700',                               dot: 'bg-red-600 dark:bg-red-500',               step: null },
