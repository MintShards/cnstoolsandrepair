    ...
    <main className="relative">
      ...
      <section className="px-6 py-16 bg-slate-50 dark:bg-slate-950">
        <div className="text-center mb-12">
          ...
          <h3 className="text-3xl font-black tracking-tight uppercase">Built for Industry</h3>
        </div>
      ...
      {/* CTA Section */}
      <section className="px-6 py-20 bg-slate-900 relative overflow-hidden text-center">
        ...
        <div className="flex flex-col items-center gap-6 relative z-10">
          ...
          <h3 className="text-3xl font-black text-white leading-tight uppercase tracking-tight">Get Back Online</h3>
          <p className="text-slate-300 max-w-sm font-medium mx-auto">
          ...
          <div className="flex flex-col w-full gap-3 mt-4">
            <a href="/quote" className="w-full">
              <button className="w-full h-16 bg-primary text-white font-black rounded-xl flex items-center justify-center gap-3 shadow-2xl shadow-primary/40 border border-primary/50 uppercase">
                <span className="material-symbols-outlined">fact_check</span>
                Request a Quote
              </button>
            </a>
            <a href="/contact" className="w-full">
              <button className="w-full h-16 bg-white/5 text-white font-black rounded-xl border border-white/20 backdrop-blur-md flex items-center justify-center gap-2 uppercase">
