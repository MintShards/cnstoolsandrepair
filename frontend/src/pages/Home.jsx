...
export default function Home() {
  ...
  const seoData = homeContent?.seo || {
    title: 'Pneumatic Tool Repair in Surrey, BC | CNS Tool Repair',
    description: 'Industrial pneumatic tool repair in Surrey, BC. Professional diagnostics, OEM-compatible parts, and in-shop service for automotive, fleet, and manufacturing.',
