...
export const CANCEL_BTN_CLS = 'flex-1 py-2.5 border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-400 font-bold rounded-xl transition-colors hover:bg-slate-50 dark:hover:bg-slate-800 text-sm';

export const SUBMIT_BTN_CLS = 'flex-1 py-2.5 bg-primary hover:bg-blue-500 text-white font-black rounded-xl transition-colors text-sm uppercase disabled:opacity-50 disabled:cursor-not-allowed';
