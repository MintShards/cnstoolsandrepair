...
// text-base below sm: iOS Safari zooms the page when a control under 16px
// gets focus; sm+ keeps the 14px desktop look.
export const FILTER_INPUT = 'w-full sm:w-auto px-3 py-2.5 bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700/60 rounded-xl text-base sm:text-sm text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/40 transition-all';
