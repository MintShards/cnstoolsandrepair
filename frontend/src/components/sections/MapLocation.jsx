    ...
    <section className="px-6 sm:px-8 lg:px-12 py-16 sm:py-20 lg:py-24 bg-white dark:bg-slate-950">
      <div className="max-w-screen-xl mx-auto">
        <div className="text-center mb-8 sm:mb-10 lg:mb-16">
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black tracking-tight uppercase px-4">Visit Our Facility</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 sm:gap-8 lg:gap-10">
          ...
          <div className="lg:col-span-2 flex flex-col gap-4 sm:gap-5 lg:gap-6 lg:h-[600px]">
            ...
            <div className="p-4 sm:p-6 lg:p-8 bg-slate-100 dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 flex-grow">
              <div className="flex items-start gap-3 sm:gap-4 mb-4 sm:mb-6">
                ...
                <div className="flex-grow">
                  <h3 className="text-base sm:text-lg lg:text-xl font-black uppercase tracking-tight mb-1 sm:mb-2">CNS Tool Repair</h3>
              ...
              <div className="space-y-3 sm:space-y-4 pt-4 sm:pt-6 border-t border-slate-200 dark:border-slate-700">
                <div className="flex items-start gap-2 sm:gap-3">
                  <span className="material-symbols-outlined text-primary text-lg sm:text-xl shrink-0" aria-hidden="true">schedule</span>
                  <div className="text-xs sm:text-sm font-bold text-slate-700 dark:text-slate-300">
                    <p>{hours.weekdays}</p>
                    <p className="text-slate-600 dark:text-slate-400 text-[10px] sm:text-xs mt-1">{hours.weekend}</p>
                  </div>
                </div>
                <div className="flex items-center gap-2 sm:gap-3">
                  <span className="material-symbols-outlined text-primary text-lg sm:text-xl" aria-hidden="true">mail</span>
                  <a
                ...
                <div className="flex items-center gap-2 sm:gap-3">
                  <span className="material-symbols-outlined text-primary text-lg sm:text-xl" aria-hidden="true">call</span>
                  <a
            ...
            >
              <span className="material-symbols-outlined text-xl sm:text-2xl" aria-hidden="true">directions</span>
            ...
            <div className="p-4 sm:p-5 lg:p-6 bg-accent-orange/10 border border-accent-orange/30 rounded-2xl">
              <div className="flex gap-2 sm:gap-3 items-start">
                <span className="material-symbols-outlined text-accent-orange text-lg sm:text-xl shrink-0" aria-hidden="true">info</span>
                <div>
                  <h3 className="font-black text-[10px] sm:text-xs lg:text-sm uppercase tracking-tight mb-1">On-Site Service Only</h3>
